                    ...
                    <div class="card-body form-container">
                        <form action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" name="phone" value="{{ $teacher->phone }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jabatan" class="col-md-4 col-form-label text-md-right">Jabatan</label>
                                <div class="col-md-6">
                                    <input id="jabatan" type="text" class="form-control" name="jabatan" value="{{ $teacher->jabatan }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="address" class="col-md-4 col-form-label text-md-right">Alamat</label>
                                <div class="col-md-6">
                                    <input id="addres" type="text" class="form-control" name="addres" value="{{ $teacher->addres }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="gender" name="gender" class="form-control">
                                        <option value="male" {{ $teacher->gender == 'male' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="female" {{ $teacher->gender == 'female' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($teacher->photo)
                                        <img src="{{ asset('storage/'.$teacher->photo) }}" class="mt-2" width="100">
                                    @endif
                                </div>
                            </div>
